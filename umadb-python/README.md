...
The Python package `umadb` provides a synchronous client for reading and appending events to
[UmaDB](https://umadb.io/) over its [gPRC API]((https://umadb.io/grpc-api.html)) using
[Rust-powered bindings](https://umadb.io/rust-client.html) via [PyO3](https://pyo3.rs/).
