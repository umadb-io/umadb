...
class Event:
    ...
    def __new__(cls, event_type: builtins.str, data: typing.Sequence[builtins.int], tags: typing.Optional[typing.Sequence[builtins.str]] = None, uuid: typing.Optional[builtins.str] = None, metadata: typing.Optional[typing.Mapping[builtins.str, builtins.str]] = None) -> Event: ...
    def __repr__(self) -> builtins.str: ...
